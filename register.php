...
<html lang="en" class="bg-[#09090d] text-white overflow-x-hidden">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="https://cdn.discordapp.com/icons/1027337534931488819/dae0002cd5919c3d8a7880853d836cad.webp" type="image/x-icon">
            ...
            <nav class="border-gray-200 px-4 lg:px-6 py-2.5 mb-14">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="../" class="flex items-center">
                        <img src="https://cdn.discordapp.com/icons/1027337534931488819/dae0002cd5919c3d8a7880853d836cad.webp" class="mr-3 h-12 mt-2"
                            alt="KeyAuth Logo" />
                    </a>
